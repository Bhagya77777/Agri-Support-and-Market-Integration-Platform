  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.email === "admin@gmail.com" && formData.password === "123") {
      localStorage.setItem(
        "user",
        JSON.stringify({ email: "admin@gmail.com", isAdmin: true })
      );
      setLoading(false);
      navigate("/admin_home");
      return;
    ...
    <div className="bg-yellow-50 min-h-screen py-16 px-4 flex items-center justify-center">
      <div className="bg-white shadow-md rounded-lg border border-brown-200 max-w-md w-full">
        <div className="bg-green-50 border-b border-brown-200 p-5 text-center">
          <h3 className="text-green-700 font-bold text-lg mb-1">
            Welcome Back
          </h3>
          <p className="text-brown-500 text-green-300">
            Please enter your credentials to login
          </p>
        </div>
        <div className="p-6">
          {error && (
            <div className="bg-red-100 text-red-700 border border-red-500 p-3 rounded mb-4">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label
                htmlFor="email"
                className="text-green-700 font-medium block mb-1"
              >
                Email address
              </label>
              <input
            ...
            <div className="mb-4">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-orange-700 text-sm">
                  Forgot password?
                </a>
              </div>
              <input
            ...
            <div className="mb-4 flex items-center gap-2">
              ...
              />
              <label htmlFor="rememberMe" className="text-green-400">
                Remember me
              </label>
            </div>
            ...
            <div className="text-center mt-4">
              <p className="text-brown-500">
                ...
                <button
                  ...
                  onClick={() => navigate("/farmer_signup")}
                >
                  Sign up here
                </button>
              </p>
